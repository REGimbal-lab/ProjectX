...
namespace StarForce
{
    public static class EntityExtension
    {
        ...
        public static void ShowPlayerDragon(this EntityComponent entityComponent, PlayerDragonData data)
        {
            entityComponent.ShowEntity(typeof(PlayerDragon),"Dragon",Constant.AssetPriority.DragonAsset,data);
        }
        ...
        public static void ShowGameGround(this EntityComponent entityComponent, GameGroundData data)
        {
            entityComponent.ShowEntity(typeof(GameGround),"Ground",Constant.AssetPriority.GameGroundAsset,data);
        }
